...
class StreakDay {
  ...
  const StreakDay({required this.label, required this.status, this.category});
}
...
class _DayBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _Bar(status: day.status, category: day.category),
...
class _Bar extends StatelessWidget {
  ...
  const _Bar({required this.status, this.category});
