...
class TooltipContent {
  ...
  factory TooltipContent.progress({required String category, required int count}) =>
      TooltipContent._(type: TooltipContentType.progress, category: category, count: count);
